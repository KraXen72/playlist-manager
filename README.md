...
<!-- vscode-markdown-toc -->
* [Use cases:](#Usecases:)
	* [1. you have your music sorted like this:](#youhaveyourmusicsortedlikethis:)
	* [2. you want to use a song in multiple different playlists, but don't want to have the file x times](#youwanttouseasonginmultipledifferentplaylistsbutdontwanttohavethefilextimes)
	* [3. you want to make a playlist which contains multiple artists/albums](#youwanttomakeaplaylistwhichcontainsmultipleartistsalbums)
	* [Actually playing the playlists](#Actuallyplayingtheplaylists)
* [Installing](#Installing)
* [Other Features](#OtherFeatures)
	* [General](#General)
	* [Settings](#Settings)
	* [Search](#Search)
	* [Playlist generation](#Playlistgeneration)
...
### <a name='youhaveyourmusicsortedlikethis:'></a>1. you have your music sorted like this:
```
artist  - single.mp3
        - single2.mp3
        - album1    - song1.mp3
...
### <a name='youwanttouseasonginmultipledifferentplaylistsbutdontwanttohavethefilextimes'></a>2. you want to use a song in multiple different playlists, but don't want to have the file x times
...
### <a name='youwanttomakeaplaylistwhichcontainsmultipleartistsalbums'></a>3. you want to make a playlist which contains multiple artists/albums
...
### <a name='Actuallyplayingtheplaylists'></a>Actually playing the playlists
...
### <a name='Playlistgeneration'></a>Playlist generation
...
## <a name='supportdevelopment'></a>support development
